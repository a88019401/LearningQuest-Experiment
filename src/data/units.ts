...
const UNIT1_WORDS: UnitConfig["words"] = [
  { term: "shy", def: "adj. 害羞的", note: "常用來形容人個性害羞，不太敢主動開口；不要和 ashamed（感到羞愧的）混淆。" },
  { term: "lonely", def: "adj. 寂寞的；孤獨的", note: "lonely 強調「感到孤單」；alone 只是「單獨一個人」，不一定有寂寞感。" },
  { term: "deal", def: "n. 約定；交易", note: "常考固定用法 It’s a deal.（一言為定）；也可指買賣、交易。" },
  { term: "national", def: "adj. 國家的；國立的", note: "字尾 -al 常見於形容詞；可連到 nation（國家），如 national holiday 國定假日。" },
  { term: "row", def: "n. 一排；一行；一列", note: "常見片語 in a row＝連續；也常用在教室座位、電影院座位題。" },
  { term: "grade", def: "n. 年級；成績", note: "一字兩義常考：the ninth grade 是九年級，get a good grade 是拿到好成績。" },
  { term: "miss", def: "v. 想念；錯過；趕不上", note: "一字多義重點字：miss my mom（想念）、miss the bus（錯過／沒趕上公車）。" },
  { term: "quite", def: "adv. 相當；頗", note: "副詞，常用來修飾形容詞，如 quite big、quite good；作文和閱讀都常見。" },
  { term: "correct", def: "v. 更正；adj. 正確的", note: "可當動詞也可當形容詞；反義字是 incorrect（不正確的），考詞性轉換時要注意。" },
  { term: "power", def: "n. 力量；權力；電力", note: "常考一字多義：電力、能力、影響力都可以；如 the power is off 表示停電。" },
  { term: "course", def: "n. 課程；路線", note: "不要只背成課程；在閱讀裡也常表示路線、方向、進程。" },
  { term: "mind", def: "v. 介意", note: "必背句型 Do you mind + V-ing...?（你介意……嗎？）；後面要接動名詞。" },
  { term: "study", def: "n./v. 研究；學習", note: "可當動詞『學習』，也可當名詞『書房』或『研究』；要靠前後文判斷詞義。" },
  { term: "sign", def: "n. 跡象；徵兆；標誌", note: "閱讀常考一字多義：traffic sign 是標誌，a sign of rain 是下雨的徵兆。" },
  { term: "country", def: "n. 鄉村；鄉下；國家", note: "常考語境判斷：in the country 是在鄉下；a country in Asia 則是國家。" },
  { term: "sight", def: "n. 視線；景象；視力", note: "一字多義重點：lose one’s sight 是失明，an amazing sight 是驚人的景象。" },
  { term: "tidy", def: "adj./v. 整齊的；整理", note: "可當形容詞『整齊的』，也可當動詞『整理』；反義字常見 messy。" },
  { term: "item", def: "n. 品項；項目", note: "菜單、清單、購物題常見；menu item 指菜單上的一個品項。" },
  { term: "repeat", def: "v. 重複；重說", note: "口說課和聽力題常見；老師請學生再說一次時常用 repeat。" },
  { term: "package", def: "n. 包裹；一小包", note: "生活情境字，常出現在網購、寄送、郵差送貨的題目中。" },

  { term: "either", def: "adv./pron./adj. 也（不）；任一的；任一者", note: "常和 neither 一起考；否定附和可用 I don’t, either.；兩者擇一也可用 either。" },
  { term: "neither", def: "adv./pron./adj. 也不；兩者都不", note: "表示兩者都不；常考 neither A nor B，或句首倒裝 Neither do I." },

  // 新補上的 8 組，同難度、可延伸進題庫
  { term: "careful", def: "adj. 小心的；仔細的", note: "常用來形容做事很仔細；可搭配 be careful、look careful，和 careless 可一起比較。" },
  { term: "noisy", def: "adj. 吵鬧的", note: "形容地方、環境或人很吵；常和 quiet（安靜的）作對照。" },
  { term: "friendly", def: "adj. 友善的", note: "雖然有 -ly，但它是形容詞，不是副詞；例如 a friendly dog、The teacher is friendly." },
  { term: "village", def: "n. 村莊", note: "可和 city（城市）、town（城鎮）、country（鄉下）一起比較，閱讀題常考生活場景。" },
  { term: "field", def: "n. 田野；領域", note: "除了『田野』，也可指『領域』；如 in the science field 是在科學領域中。" },
  { term: "popular", def: "adj. 受歡迎的", note: "作文、閱讀都常見；be popular with... 表示『受……歡迎』。" },
  { term: "perfect", def: "adj. 完美的；滿分的", note: "常見在成績或表現情境，如 a perfect grade、a perfect answer。" },
  { term: "amazing", def: "adj. 令人驚艷的", note: "用來形容事物『令人驚奇』；人若感到驚訝，常用 amazed。" },
];
